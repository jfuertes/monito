<?php
  ...
  if(isset($_POST['btn_send']))
  {
   ...
   try
   {
    ...
    $mail->Username   ="luislinaresburnes@gmail.com";  
                         $mail->Password   ="luislinares/*/*";            
                         $mail->SetFrom('jfuertesl2@gmail.com','Programacion net');
                         $mail->AddReplyTo("luislinaresburnes@gmail.com","Programacion net");
