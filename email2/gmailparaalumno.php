                                    ...
                                    <div class="mainBox" style="width: 100%;text-align: center;background: #f2edf5;">
                                        <div class="mailBody" style="border-radius: 5px;box-shadow: -1px 2px 8px 0px #333;-webkit-box-shadow: -1px 2px 8px 0px #333;-moz-box-shadow: -1px 2px 8px 0px #333;border-top: 5px solid #ee0000;font-family: &quot;Helvetica&quot;;margin: 10px auto;background: #fff;padding: 20px;width: 560px;">
                                            ...
                                            <p style="text-align:left">Hola
                                                <br> Te contactaste con un Profesor de la plataforma MiProfe.club </p>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td valign="left" style="width:100px">
                                                                        <div style="width:auto;padding:10px 20px"><img class="m_8364780055853349296fluid CToWUd" border="0" src="https://miprofe.club/IMG/profes/'.$username.'.'.$extension.'" width="80px" weight="80px" style="margin:auto">
                                                                        </div>
                                                                    </td>
                                            ...
                                            <a href="https://miprofe.club/alumno/#/perfilprofe/'.$username.'">
                                                <button class="gotoBtn" style="height: 50px;border: 2px solid #ee0000;border-radius: 50px;padding: 0 4em;margin-top: 30px;font-family: &quot;Helvetica&quot;, Arial, sans-serif;font-size: 1.2em;font-weight: normal;background-color: #ee0000;color: #ffffff;"> Ver Perfil del profesor </button>
                                            </a>
